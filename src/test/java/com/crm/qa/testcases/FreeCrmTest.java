...
public class FreeCrmTest {
	...
	public void setUp() throws Exception {
		System.setProperty("webdriver.chrome.driver", "/Users/Deepanshu.garhewal/SampleProject/chromedriver-win64/chromedriver.exe");
	...
	public static void getRunTimeInfoMessage(String messageType, String message) throws InterruptedException {
		...
		// js.executeScript("$.getScript('/Users/Deepanshu.garhewal/Documents/workspace/Test/src/testcases/jquery.growl.js')");
...
//		js.executeScript("$.growl.warning({ title: 'Warning!', message: 'your warning message goes here' });");
	...
	public static void takeScreenshot(String fileName) throws IOException{
		...
		FileUtils.copyFile(src, 
				new File("/Users/Deepanshu.garhewal/Documents/MyPOMFramework/PageObjectModel/screenshots/" + fileName +".png"));
